...
/// <summary>
/// 已弃用的 KPC 平方根自适应事件列表合并器，行为与 <see cref="Intermediate.EventListMergerSqrt{TPayload}"/> 一致。
/// </summary>
/// <typeparam name="TPayload">事件值类型。</typeparam>
[Obsolete("已弃用：请迁移至 KaedePhi.Tool.Event.Intermediate.EventListMergerSqrt{TPayload}。")]
public class EventListMergerSqrt<TPayload>
    : Intermediate.EventListMergerSqrt<TPayload>,
    ...
    where TPayload : notnull
{
    ...
    [Obsolete("已弃用：请迁移至 EventListMergerSqrt{TPayload}.EventListMerge。")]
