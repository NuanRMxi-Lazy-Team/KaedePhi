...
/// <summary>
/// 已弃用的 KPC 事件列表合并器，行为与 <see cref="Intermediate.EventListMerger{TPayload}"/> 一致。
/// </summary>
/// <typeparam name="TPayload">事件值类型。</typeparam>
[Obsolete("已弃用：请迁移至 KaedePhi.Tool.Event.Intermediate.EventListMerger{TPayload}。")]
public class EventListMerger<TPayload>
    : Intermediate.EventListMerger<TPayload>,
    ...
    where TPayload : notnull
{
    ...
    [Obsolete("已弃用：请迁移至 EventListMerger{TPayload}.EventListMerge。")]
