...
/// <summary>
/// 已弃用的 KPC 自适应事件列表合并器，行为与 <see cref="Intermediate.EventListMergerPlus{TPayload}"/> 一致。
/// </summary>
/// <typeparam name="TPayload">事件值类型。</typeparam>
[Obsolete("已弃用：请迁移至 KaedePhi.Tool.Event.Intermediate.EventListMergerPlus{TPayload}。")]
public class EventListMergerPlus<TPayload>
    : Intermediate.EventListMergerPlus<TPayload>,
    ...
    where TPayload : notnull
{
    ...
    [Obsolete("已弃用：请迁移至 EventListMergerPlus{TPayload}.EventListMerge。")]
