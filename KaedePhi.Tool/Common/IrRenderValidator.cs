...
/// 校验渲染配置、目标索引和位图安全边界。
/// </summary>
public static class IrRenderValidator
{
    ...
    /// <param name="options">渲染配置。</param>
    /// <returns>无返回值。</returns>
    public static void ValidateOptions(IrRenderOptions options)
    {
    ...
    /// <param name="options">渲染配置。</param>
    /// <returns>无返回值。</returns>
    public static void ValidateEventLayer(IrEvents.EventLayer layer, IrRenderOptions options)
    {
    ...
    private static double GetLayerTotalBeats(IrEvents.EventLayer layer)
    {
    ...
    private static void ValidateSamplingOptions(IrRenderOptions options)
    {
    ...
    private static void ValidateLayoutOptions(IrRenderOptions options)
    {
        if (
    ...
    private static void ValidateRangeOptions(IrRenderOptions options)
    {
