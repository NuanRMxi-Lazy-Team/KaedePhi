...
public static class ConvertCommand
{
    ...
    {
        Description = CliHelper.L("convert_command_opt_target"),
    ...
    {
        Description = CliHelper.L("convert_opt_unbind_classic"),
    };
    ...
    {
        Description = CliHelper.L("convert_opt_negative_alpha_elevation"),
    };
    ...
    {
        var cmd = new Command("convert", CliHelper.L("convert_command_desc"))
        {
            InputOpt,
            OutputOpt,
            WorkspaceOpt,
